...
export default function DashboardReportsPage() {
  ...
  const reports = [
    ...
    {
      type: "items",
      title: t("menuItemsReport"),
      description: t("menuItemsReportDesc"),
  ...
  const downloadReport = async (
    ...
    try {
      ...
      if (type === "scans") {
        ...
        stats = [
          { label: t("totalItems"), value: summary.total ?? 0 },
          { label: "Categories", value: summary.categoriesCount ?? 0 },
          { label: "Avg Price", value: summary.avgPrice ?? 0 },
        ];
        if (summary.categoryBreakdown) {
          chartTitle = "Items per Category";
          charts = buildBreakdownCharts(
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-gray-500">{t("reportsDescription")}</p>
      </div>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg border border-indigo-200 bg-white px-3 py-2 text-xs sm:text-sm font-medium text-indigo-600 transition hover:bg-indigo-50 disabled:opacity-50"
                >
